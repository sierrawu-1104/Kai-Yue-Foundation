/* Central EN / Simplified Chinese dictionary for the whole site.
...
window.KY_I18N = {
  ...
  footer: {
    copyright: { en: "© Kai Yue Foundation. All rights reserved.", zh: "© 恺悦基金会 版权所有" },
  },

  index: {
    heroLine1: { en: "Advancing Education.", zh: "推动教育。" },
    heroLine2: { en: "Elevating Arts.", zh: "提升艺术。" },
    heroLine3: { en: "Enriching Community.", zh: "丰富社区。" },
    ...
    missionText: {
      ...
      zh: "恺悦基金会（KAI YUE FOUNDATION）是由黄吉姆（Jim Huang）家族创立的非营利私人基金会（享有501(c)3免税资格）。本基金会致力于推动慈善与教育事业，强化并提升我们生活与工作所在的社区。透过投入基金会资源，我们得以在社区中建立长久的情谊，并促进文化的发展。",
    },
    missionCta: { en: "See Our Events", zh: "查看我们的活动" },
    pillarsHeading: { en: "Ways We Give Back", zh: "我们回馈社会的方式" },
    pillarChineseLabel: { en: "Chinese Communities", zh: "华人社区" },
    pillarChineseText: {
      ...
      zh: "透过支持教育计划、文化音乐会与活动，以及理念相近的慈善组织，强化并颂扬华人社区。",
    },
    pillarArtsLabel: { en: "Performing Arts", zh: "表演艺术" },
    pillarArtsText: {
      ...
      zh: "透过赞助深具意义的文化节目，包括音乐节、现场演出、管弦乐团、室内乐及其他艺术活动，支持并提升艺术水平，激发创造力并丰富社区生活。",
    },
    ...
    pillarEducationText: {
      ...
      zh: "为经济确有需要、已获录取或正就读于认可教育机构的学生提供奖学金，协助扩大教育与机会的取得管道。",
    },
    pillarPhysicsLabel: { en: "Physics", zh: "物理学" },
    pillarPhysicsText: {
      ...
      zh: "为合格机构与个人提供奖助金与奖项，支持并推动物理科学的发展，并于研究、教育及学术发展等领域提供奖学金机会。",
    },
  },
  ...
  events: {
    ...
    e2026Title: { en: "Salute to Vienna New Year's Concert", zh: "《向维也纳致敬》新年音乐会" },
    e2026Text: {
      ...
      zh: "每年新年期间，恺悦基金会都会赞助《向维也纳致敬》新年音乐会，透过一系列气势磅礴的序曲、咏叹调与二重唱，包括著名的《蓝色多瑙河圆舞曲》，展现小约翰．史特劳斯（Johann Strauss, Jr.）音乐中欢庆、浪漫且动人心弦的风采，重现维也纳黄金时代的精髓。音乐会由欧洲顶尖歌唱家、享誉国际的舞者及完整管弦乐团共同演出。",
    },

    e2025aTitle: { en: "Lea Salonga at the Kravis Center", zh: "Lea Salonga 于柯维斯中心演出" },
    e2025aText: {
      ...
      zh: "恺悦基金会赞助了Lea Salonga在柯维斯中心的首次演出。音乐会涵盖Lea多个经典舞台与影视角色的歌曲，包括《西贡小姐》（Miss Saigon）、《悲惨世界》（Les Misérables）、《阿拉丁》（Aladdin）与《花木兰》（Mulan），以及广受好评的百老汇与伦敦西区热门剧作《老朋友》（Old Friends）中的新曲，还有百老汇经典名曲、流行金曲，以及她辉煌演艺生涯中的更多精彩曲目。",
    },

    e2025bTitle: { en: "Sound of Harvest 2025:<br> A Season in Harmony", zh: "丰收之声 2025：<br>和谐的季节" },
    e2025bText: {
      ...
      zh: "美洲中国音乐家协会透过一场鼓舞人心的音乐、文化与艺术庆典，将社区凝聚在一起。恺悦基金会很荣幸能成为此次活动的赞助者之一，支持其透过艺术表达与深具意义的社区参与来丰富生活的使命。",
    },

    e2024Title: { en: "Vienna Philharmonic at Kravis", zh: "维也纳爱乐于柯维斯中心演出" },
    e2024Text: {
      ...
      zh: "维也纳爱乐乐团终于首度登台柯维斯中心，此乐团普遍被誉为世界上最杰出、最重要的管弦乐团之一，并由客席指挥法兰兹．威尔瑟－莫斯特（Franz Welser-Möst）共同演出。恺悦基金会是维也纳爱乐此次演出的赞助者之一，曲目包括阿尔班．贝尔格（Alban Berg）的《管弦乐三首》以及马勒气势恢宏的第九号交响曲。",
    },

    e2023Title: { en: "Cleveland Orchestra at Kravis", zh: "克里夫兰管弦乐团于柯维斯中心演出" },
    e2023Text: {
    ...
    e2016aText: {
      ...
      zh: "2016年7月30日晚7：30，恺悦基金隆重推出享誉世界的小提琴演奏家吕思清的独奏音乐会。演出在普林斯顿大学Richardson音乐厅举行，大约700人观看了演出。",
    },

    e2016bTitle: { en: "McCarter Theatre Gala Benefit", zh: "麦卡特剧院慈善晚宴" },
    e2016bText: {
      ...
      zh: "2016年5月7日（星期六）举行的麦卡特剧院慈善晚宴，以鸡尾酒会、晚宴，以及在麦卡特后草坪举行的现场与无声拍卖揭开序幕，草坪搭起帐篷，化身为一场美妙夜晚的绝佳场地。晚宴后，郎朗（Lang Lang）带来精彩演出。恺悦基金会是本次晚宴筹办委员会的成员之一。本次晚宴共为麦卡特剧院筹得超过14万美元善款。",
    },

    e2015Title: { en: "Journey of Love", zh: "爱的旅程" },
    e2015Text: {
    ...
    e2014aText: {
      ...
      zh: "[塞翁失马]大型音乐史诗于2014年6月6日在普林斯顿大学Richardson音乐厅隆重上演。这是由恺悦基金创意并赞助，由Tim Keyes乐团创作并演奏的独创音乐史诗。由西方现代管弦乐、合唱及独奏演绎一个古老的中国寓言故事。世界首演。",
    },
    ...
    e2014cTitle: { en: "Plainsboro Chinese New Year Gala", zh: "普兰斯堡中文学校春节晚会" },
    e2014cText: {
      ...
      zh: "恺悦基金会赞助的普兰斯堡中文学校【万马奔腾】春节晚会于2014年2月3日晚在麦卡特剧场举行。<br> <br>由恺悦基金会协办，普兰斯堡中文学校主办，【金蛇狂舞】春节晚会于2013年2月10日晚在普兰斯堡高中举行。",
    },
  },

  gallery: {
    viewToggleAll: { en: "See All Photos", zh: "查看全部照片" },
    viewToggleFeatured: { en: "See Featured Photos", zh: "查看精选照片" },
    featuredLabel: { en: "FEATURED: Lea Salonga", zh: "精选：Lea Salonga" },
    placeholderText: { en: "More photos coming soon.", zh: "更多照片即将推出。" },
    prevPhoto: { en: "Previous photo", zh: "上一张照片" },
    nextPhoto: { en: "Next photo", zh: "下一张照片" },
    prevColumn: { en: "Previous column", zh: "上一栏" },
    nextColumn: { en: "Next column", zh: "下一栏" },
    eventJourneyOfLove: { en: "Journey of Love Gala", zh: "爱的旅程晚会" },
    eventMcCarterGala: { en: "McCarter Theatre Gala", zh: "麦卡特剧院晚宴" },
    eventLuSiqing: { en: "Lu Siqing Violin Solo Concert", zh: "吕思清小提琴独奏音乐会" },
    eventBlendingEastWest: { en: "Blending of East and West Concert", zh: "东西交融音乐会" },
    eventLiChuanyun: { en: "Li Chuanyun Violin Concerto Concert", zh: "李传韵小提琴协奏音乐会" },
    eventPlainsboroGala: { en: "Plainsboro Chinese New Year Gala", zh: "普兰斯堡中文学校春节晚会" },
  ...
  partnerships: {
    ...
    venuesHeading: { en: "Venues", zh: "场地" },
    organizationsHeading: { en: "Organizations", zh: "机构组织" },
    educationHeading: { en: "Education", zh: "教育机构" },

    carnegieName: { en: "Carnegie Hall", zh: "卡内基音乐厅" },
    carnegieLocation: { en: "New York, NY", zh: "纽约州纽约市" },
    carnegieText: {
      ...
      zh: "卡内基音乐厅是位于美国纽约市曼哈顿中城的音乐会场地，坐落于第七大道881号，介于西56街与西57街之间，距离中央公园以南仅两个街区。卡内基音乐厅的使命，是在这座传奇音乐厅的三个舞台上呈现非凡的音乐与音乐家，将音乐的变革力量带给尽可能广泛的观众，提供具远见的教育课程，并透过培育新作品、新艺术家与新观众，开创音乐的未来。",
    },

    kravisName: { en: "Kravis Center for the Performing Arts", zh: "柯维斯表演艺术中心" },
    kravisLocation: { en: "West Palm Beach, FL", zh: "佛罗里达州西棕榈滩" },
    kravisText: {
      ...
      zh: "雷蒙德．F．柯维斯表演艺术中心位于佛罗里达州西棕榈滩市中心核心地带，是南佛罗里达首屈一指的文化地标，也是世界级娱乐演出的首选之地。柯维斯中心旗下各具特色的场馆，呈现内容丰富多元的节目，包括备受赞誉的百老汇制作、古典音乐会、喜剧表演、文化活动，以及深具影响力的艺术教育计划。",
    },

    mccarterName: { en: "McCarter Theatre", zh: "麦卡特剧院" },
    mccarterLocation: { en: "Princeton, NJ", zh: "纽泽西州普林斯顿" },
    mccarterText: {
      ...
      zh: "位于普林斯顿的麦卡特表演艺术剧院中心，是全美最活跃的文化中心之一，每年举办超过200场戏剧、舞蹈、音乐及特别活动演出。麦卡特的观众群遍及整个地区，每季有超过20万人次前来观赏演出，观众来自纽泽西州全部21个郡，以及宾夕法尼亚州、纽约州和另外23个州。",
    },

    timKeyesName: { en: "Tim Keyes Consort", zh: "提姆．凯伊斯合奏团" },
    timKeyesLocation: { en: "Plainfield, NJ", zh: "纽泽西州普兰菲尔德" },
    timKeyesText: {
      ...
      zh: "提姆．凯伊斯合奏团是一个纽泽西州的501(c)3非营利机构，成立宗旨纯为慈善、教育、文化与文学目的。提姆．凯伊斯持续寻觅才华洋溢、理念相近的音乐家，演出全新创作与经典的合唱及管弦乐曲目。对卓越的追求贯穿合奏团的每个面向，从组织架构、节目规划到现场演出，提姆．凯伊斯对旗下音乐家与支援团队皆要求最高水准。",
    },

    pkuName: { en: "Peking University Alumni Association", zh: "北京大学校友会" },
    pkuLocation: { en: "New York, NY", zh: "纽约州纽约市" },
    pkuText: {
      ...
      zh: "北京大学校友会（PKUAA）是一个在纽约州注册的501(c)3非营利组织，服务大纽约地区的北京大学校友。其使命为维护并促进校友福祉；协助推动校友的个人与专业发展；促进并增进校友彼此之间，以及与母校之间的沟通与联系；协助支持母校的发展；并作为母校与其他机构之间，以及中美之间资讯交流、相互理解与合作的平台。",
    },

    aawmaName: { en: "American Alliance for World Music and Arts", zh: "美洲世界音乐艺术联盟" },
    aawmaLocation: { en: "Princeton, NJ", zh: "纽泽西州普林斯顿" },
    aawmaText1: {
      ...
      zh: "美洲世界音乐艺术联盟（AAWMA）是一个非营利组织，致力于透过创新节目拓展中国音乐丰富的旋律与多元曲目，并鼓励跨艺术形式的合作。联盟致力促进多元文化世界音乐的创作、演出、教学与行政工作，并鼓励世界音乐领域内外的交流。AAWMA汇聚了音乐大师、艺术家、教育工作者，以及才华洋溢的青年与团体，以各种可能的风格与方式，向美国社会引介中国音乐。",
    },
    aawmaText2: {
      ...
      zh: "AAWMA的教育计划向来致力于邀请音乐大师莅临，并推广、呈现未来的新兴人才。2010年及2012年，AAWMA成功举办了两届国际中国音乐节，分别于中国国家交响乐团（北京）及2012年普林斯顿大学举行，并由中国国家交响乐团与普林斯顿大学中乐团共同协办。这些节目不仅为社区成员带来喜悦，也协助发掘下一代兼具中西音乐融合能力的优秀古典音乐家。",
    },

    mchfName: { en: "Montreal Chinese Hospital Foundation", zh: "蒙特娄华人医院基金会" },
    mchfLocation: { en: "Montreal, Quebec", zh: "魁北克省蒙特娄" },
    mchfText1: {
      ...
      zh: "蒙特娄华人医院基金会成立于1972年，宗旨为接收并管理善款，以捐赠、资助及赞助蒙特娄华人医院，以及魁北克省蒙特娄华人社区所需且受益的其他相关医疗服务。",
    },
    mchfText2: {
      ...
      zh: "所募集的善款用于资助蒙特娄华人医院添购未被魁北克省卫生及社会服务部预算涵盖的设备与病患照护服务。善款亦透过蒙特娄华人医院，资助如产前护理计划等其他医疗服务，嘉惠蒙特娄华人社区。",
    },

    mcccaName: { en: "Montreal Center of Chinese Culture and Arts", zh: "蒙特娄中华文化艺术中心" },
    mcccaLocation: { en: "Montreal, Quebec", zh: "魁北克省蒙特娄" },
    mcccaText1: {
      ...
      zh: "蒙特娄中华文化艺术中心（MCCCA）于1996年8月11日在蒙特娄成立，是大蒙特娄地区同类组织中规模最大、成立最早的机构。中心下设民族舞蹈、民乐器乐团、声乐组、腰鼓队、舞狮队、艺术学校及文化服务等单位。",
    },
    mcccaText2: {
    ...
    peddieLocation: { en: "Hightstown, NJ", zh: "纽泽西州海茨敦" },
    peddieText: {
      ...
      zh: "秉持校训「功成再启」所展现的自信，佩迪学校致力于每位学生在智识、社交与品格上的成长。我们欢迎拥有多元才华与背景的学生，他们的热情、好奇心与品格，共同塑造出充满求知热忱的教育社群。在这样的寄宿学校环境中，我们不仅为学生做好迎接大学挑战与回报的准备，更激励每位学生追求最高品质的公民素养。",
    },

    princetonDayName: { en: "Princeton Day School", zh: "普林斯顿走读学校" },
    princetonDayLocation: { en: "Princeton, NJ", zh: "纽泽西州普林斯顿" },
    princetonDayText: {
      ...
      zh: "普林斯顿走读学校致力培育每位学生的心智、体魄与品格。在学术、体育、艺术与服务等各领域，我们赞扬对个人卓越的追求，以及凝聚社群的合作精神。我们追求文化、观点与才华的多元性，以促进学生的智识成长与品德发展。诚信、尊重与同理心是本校使命的核心。我们的学生离开普林斯顿走读学校后，皆已充分准备好迎接大学及未来的挑战：具备知识行事、审慎领导、慷慨分享及切实贡献的能力。",
    },

    yinghuaName: { en: "YingHua Language School", zh: "应华语言学校" },
    yinghuaLocation: { en: "Lawrenceville, NJ", zh: "纽泽西州劳伦斯维尔" },
    yinghuaText: {
      ...
      zh: "应华语言学校是一所位于纽泽西州劳伦斯维尔的非营利组织。其创校理念是建立一所专注投入学生中文教育的语言学校，让毕业生真正掌握扎实的语言能力。目前，该校是纽泽西州唯一全面采用马立平博士「汉字直接认读」教学法的学校，教授现代简体中文字，并在适当阶段导入拼音系统作为辅助工具。",
    },

    huaxiaName: { en: "Huaxia Chinese School", zh: "华夏中文学校" },
    huaxiaLocation: { en: "Plainsboro, NJ", zh: "纽泽西州普兰斯堡" },
    huaxiaText: {
      ...
      zh: "华夏中文学校是一所独立、非营利、无宗教与政治色彩的文化教育机构，宗旨包括教授中文语言与中华文化，并于社区推展文化认识活动。主要中文课程涵盖幼儿园至九年级，并设有中文进阶班及中文作为第二语言（CSL）课程。文化课程包括功夫、太极、击剑、体操、羽毛球、排球、围棋、象棋、数学、中国传统乐器、绘画及手工艺。目前在校学生约800人，是华夏中文学校体系中规模最大的分校。",
    },
  },
  ...
  contact: {
    ...
    sendUsMessage: {
      ...
      zh: "传送<br>讯息给我们<span class=\"contact-accent-dot\"></span>",
    },
    contactInfoHeading: {
      en: "Contact <br>Info<span class=\"contact-accent-dot\"></span>",
      zh: "联络<br>资讯<span class=\"contact-accent-dot\"></span>",
    },
    namePlaceholder: { en: "Your full name*", zh: "您的全名*" },
    emailPlaceholder: { en: "Email address*", zh: "电子邮件地址*" },
    messagePlaceholder: { en: "Tell us about your inquiry or project idea!", zh: "请告诉我们您的询问内容或提案构想！" },
    fileLabel: { en: "Attach Donation Application PDF (optional)", zh: "附上捐款申请PDF文件（选填）" },
    reachingOutAbout: { en: "I'm reaching<br>out about", zh: "我想咨询<br>的主题是" },
    generalInquiry: { en: "General Inquiry", zh: "一般咨询" },
    donationApplication: { en: "Donation Application", zh: "捐款申请" },
    sendButton: { en: "SEND TO US!", zh: "送出讯息！" },
    sendingButton: { en: "SENDING...", zh: "传送中..." },
    statusSuccess: { en: "Thanks! Your message has been sent.", zh: "谢谢您！您的讯息已成功送出。" },
    statusError: {
      en: "Something went wrong. Please email us directly at huang@kyfoundation.org.",
      zh: "发生错误，请直接寄送电子邮件至 huang@kyfoundation.org。",
    },
    statusFileTooLarge: {
    ...
    eligibility5: {
      ...
      zh: "申请机构所提出的计划与服务，须符合本基金会其中一项重点关注领域。",
    },
    eligibility6: {
      ...
      zh: "申请机构须具备良好的财务管理能力，并以其最新财务报表为佐证。",
    },
    eligibility7: {
      ...
      zh: "申请机构须设有运作中的董事会，并能展现其治理制度的健全性。",
    },
    eligibility8: {
      ...
      zh: "申请机构须提供年度进度报告，说明款项运用情形及计划成效。",
    },
    eligibility9: { en: "Presentations and site visits may be required.", zh: "本基金会可能要求进行简报说明及实地访查。" },
    donationAppHeading: { en: "Donation Application", zh: "捐款申请" },
    downloadApplication: { en: "Download Application", zh: "下载申请表" },
  },
};
